...
<p>This project is written in assembly that uses the <a href="https://rgbds.gbdev.io/install">RGBDS compiler</a></p>
<h2>Play game</h2>
<div>
<canvas id="emulatorCanvas"></canvas>
        <input type="file" id="romUpload" accept=".gb, .gbc" style="display: none;" />
        <button onclick="document.getElementById('romUpload').click()">Upload ROM</button>
</div>
<h2>Credits</h2>
